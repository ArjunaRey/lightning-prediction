...
kecepatan_angin_sekarang = st.number_input("Kecepatan Angin Sekarang (km/h)", min_value=0.0, max_value=150.0, value=10.0)
...
kecepatan_angin_1jam_lalu = st.number_input("Kecepatan Angin 1 Jam Lalu (km/h)", min_value=0.0, max_value=150.0, value=9.0)
...
kecepatan_angin_2jam_lalu = st.number_input("Kecepatan Angin 2 Jam Lalu (km/h)", min_value=0.0, max_value=150.0, value=8.0)

# Menampilkan data yang dimasukkan oleh user
st.subheader("📊 Data yang Dimasukkan")
st.write("**Data Saat Ini:**")
st.write(f"Suhu: {suhu_sekarang}°C, Kelembaban: {kelembaban_sekarang}%, Tekanan: {tekanan_sekarang} hPa, Kecepatan Angin: {kecepatan_angin_sekarang} km/h")

st.write("**Data 1 Jam Lalu:**")
st.write(f"Suhu: {suhu_1jam_lalu}°C, Kelembaban: {kelembaban_1jam_lalu}%, Tekanan: {tekanan_1jam_lalu} hPa, Kecepatan Angin: {kecepatan_angin_1jam_lalu} km/h")

st.write("**Data 2 Jam Lalu:**")
st.write(f"Suhu: {suhu_2jam_lalu}°C, Kelembaban: {kelembaban_2jam_lalu}%, Tekanan: {tekanan_2jam_lalu} hPa, Kecepatan Angin: {kecepatan_angin_2jam_lalu} km/h")

# Menampilkan jam prediksi dalam UTC
